...
export const About =() => {
    ...
    const frontendSkills =["React",  "HTML5", "CSS3", "JavaScript",  "Tailwind CSS"];
   ...
   return (
    ...
    >
        ...
        <div className=" rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all ">
               ...
               web applications and creating innovative
                       ...
                       <div className="p-6 rounded-xl border border-white/10 border hover:-translate-y-1 transition-all">
                            ...
                            <ul className="list-disc list-inside text-gray-300 space-y-2">
                                <li>
                                    <strong>
                                        Bsc.CSIT
                                    </strong> - Madan Bhandari Memorial College 
                                    (8th Semester Running)
                                </li>
                                <li>
         ...
         <div className="p-6 rounded-xl border border-white/10 border hover:-translate-y-1 transition-all">
                     ...
                     <div className="space-y-4 text-gray-300">
                            <div>
                                <h4>
                                    None, still learning and exploring opportunities.
                                </h4>
                            </div>
                     </div>
                       </div>
